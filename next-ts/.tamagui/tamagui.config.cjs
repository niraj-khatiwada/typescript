...
var require_getElevation = __commonJS({
  "node_modules/@tamagui/stacks/dist/cjs/getElevation.js"(exports, module2) {
    ...
    var getElevation2 = /* @__PURE__ */ __name((size3, extras) => {
      if (!size3)
        return;
      const { tokens: tokens2 } = extras, token = tokens2.size[size3], sizeNum = (0, import_core55.isVariable)(token) ? +token.val : size3;
      return getSizedElevation2(sizeNum, extras);
    }, "getElevation");
    var getSizedElevation2 = /* @__PURE__ */ __name((val, { theme, tokens: tokens2 }) => {
      let num = 0;
      if (val === true) {
        const val2 = (0, import_core55.getVariableValue)(tokens2.size.true);
...
var require_cjs10 = __commonJS({
  "node_modules/@tamagui/get-token/dist/cjs/index.js"(exports, module2) {
    ...
    var getSize10 = /* @__PURE__ */ __name((size3, options) => getTokenRelative("size", size3, options), "getSize");
  ...
  "node_modules/@tamagui/font-size/dist/cjs/getFontSize.js"(exports, module2) {
    ...
    var getFontSizeToken = /* @__PURE__ */ __name((inSize, opts) => {
      if (typeof inSize == "number")
        return null;
      const relativeSize = (opts == null ? void 0 : opts.relativeSize) || 0, fontSize = (0, import_core55.getConfig)().fontsParsed[(opts == null ? void 0 : opts.font) || "$body"].size, size3 = inSize || ("$true" in fontSize ? "$true" : "$4"), sizeTokens = Object.keys(fontSize);
...
// node_modules/@tamagui/cubic-bezier-animator/dist/cjs/cubicBezier.js
var require_cubicBezier = __commonJS({
  "node_modules/@tamagui/cubic-bezier-animator/dist/cjs/cubicBezier.js"(exports, module2) {
    var __defProp2 = Object.defineProperty;
    var __getOwnPropDesc2 = Object.getOwnPropertyDescriptor;
    var __getOwnPropNames2 = Object.getOwnPropertyNames;
    var __hasOwnProp2 = Object.prototype.hasOwnProperty;
...
// node_modules/@tamagui/cubic-bezier-animator/dist/cjs/index.js
var require_cjs29 = __commonJS({
  "node_modules/@tamagui/cubic-bezier-animator/dist/cjs/index.js"(exports, module2) {
    var __defProp2 = Object.defineProperty;
    var __getOwnPropDesc2 = Object.getOwnPropertyDescriptor;
    var __getOwnPropNames2 = Object.getOwnPropertyNames;
    var __hasOwnProp2 = Object.prototype.hasOwnProperty;
...
var require_createAnimations = __commonJS({
  "node_modules/@tamagui/animations-css/dist/cjs/createAnimations.js"(exports, module2) {
    ...
    var import_core55 = require("@tamagui/core");
    var import_cubic_bezier_animator = require_cjs29();
    var import_use_presence2 = require_cjs2();
    var import_react44 = require("react");
    function createAnimations2(animations2) {
      return {
        View: import_core55.Stack,
        ...
        useAnimatedNumberReaction({ hostRef, value }, onValue) {
          (0, import_core55.useIsomorphicLayoutEffect)(() => {
            if (!hostRef.current)
              return;
        ...
        useAnimations: ({ props, presence, style, componentState, hostRef }) => {
          const isEntering = !!componentState.unmounted, isExiting = (presence == null ? void 0 : presence[0]) === false, sendExitComplete = presence == null ? void 0 : presence[1], initialPositionRef = (0, import_react44.useRef)(null), animationKey = Array.isArray(props.animation) ? props.animation[0] : props.animation, animation = animations2[animationKey], keys = props.animateOnly ? props.animateOnly.join(" ") : "all";
          return (0, import_core55.useIsomorphicLayoutEffect)(() => {
          ...
          }, [sendExitComplete, isExiting]), (0, import_core55.useIsomorphicLayoutEffect)(() => {
            var _a;
...
// node_modules/tamagui/dist/esm/index.js
__reExport(esm_exports2, __toESM(require_cjs16()));
...
var getElevation = /* @__PURE__ */ __name((size3, extras) => {
  if (!size3)
    return;
  const { tokens: tokens2 } = extras, token = tokens2.size[size3], sizeNum = (0, import_core4.isVariable)(token) ? +token.val : size3;
...
var ButtonIcon = /* @__PURE__ */ __name((props) => {
  const { children, scaleIcon = 1 } = props, { size: size3, color } = (0, import_react24.useContext)(ButtonContext), iconSize = (typeof size3 == "number" ? size3 * 0.5 : (0, import_font_size.getFontSize)(size3)) * scaleIcon;
...
function useButton(propsIn, { Text: Text5 = Button2.Text } = { Text: Button2.Text }) {
  const {
    ...
    textProps,
    ...rest
  } = propsIn, isNested = (0, import_react24.useContext)(ButtonNestingContext), propsActive = (0, import_web9.useProps)(propsIn), size3 = propsActive.size || (propsActive.unstyled ? void 0 : "$true"), iconSize = (typeof size3 == "number" ? size3 * 0.5 : (0, import_font_size.getFontSize)(size3)) * scaleIcon, getThemedIcon = (0, import_helpers_tamagui.useGetThemedIcon)({ size: iconSize, color }), [themedIcon, themedIconAfter] = [icon, iconAfter].map(getThemedIcon), spaceSize = propsActive.space ?? (0, import_web9.getVariableValue)(iconSize) * scaleSpace, contents = wrapChildrenInText(
    Text5,
    propsActive,
...
var PopperArrow = PopperArrowFrame.styleable(function(propsIn, forwardedRef) {
  var _a, _b;
  const { __scopePopper, ...rest } = propsIn, props = (0, import_core24.useProps)(rest), { offset: offset2, size: sizeProp, borderWidth = 0, ...arrowProps } = props, context = usePopperContext(__scopePopper), sizeVal = sizeProp ?? context.size, size3 = +(0, import_core24.getVariableValue)(
  ...
  if (primaryPlacement) {
    ...
    oppSide && (arrowStyle[oppSide] = -size3, innerArrowStyle[oppSide] = size3 / 2), (oppSide === "top" || oppSide === "bottom") && (arrowStyle.left = 0), (oppSide === "left" || oppSide === "right") && (arrowStyle.top = 0), (0, import_core24.useIsomorphicLayoutEffect)(() => {
      var _a2;
...
var PopoverContent = PopperContentFrame.extractable(
  React20.forwardRef(function(props, forwardedRef) {
    ...
    }, [context.open]), /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(PopoverContentPortal, { __scopePopover, zIndex: props.zIndex, children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(import_core25.Stack, { pointerEvents: context.open ? "auto" : "none", children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(
      PopoverContentImpl,
      {
        ...contentImplProps,
        disableRemoveScroll,
...
function PopoverContentPortal(props) {
  const { __scopePopover } = props, zIndex = props.zIndex ?? 15e4, context = usePopoverContext(__scopePopover), popperContext = usePopperContext(__scopePopover || POPOVER_SCOPE), themeName = (0, import_core25.useThemeName)();
...
var PopoverContentImpl = React20.forwardRef(function(props, forwardedRef) {
  ...
  if (context.breakpointActive) {
    ...
    return (import_react_native9.Platform.OS === "android" || import_react_native9.Platform.OS === "ios") && (content = /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(
...
var PopoverSheetController = /* @__PURE__ */ __name(({
  ...
  const context = usePopoverContext(__scopePopover), showSheet = useShowPopoverSheet(context), breakpointActive = context.breakpointActive, getShowSheet = (0, import_core25.useGet)(showSheet);
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(
    SheetController,
    {
      onOpenChange: (val) => {
...
var TooltipContent = PopperContentFrame.extractable(
  React37.forwardRef(
    ({ __scopeTooltip, ...props }, ref) => {
      const popper = usePopperContext(__scopeTooltip || TOOLTIP_SCOPE), padding = props.padding ?? props.size ?? popper.size ?? (0, import_get_token11.getSize)("$true", {
        shift: -2
      });
...
var Spinner = YStack.extractable(
  (0, import_core52.themeable)(
    React38.forwardRef((props, ref) => {
      ...
      let color = colorProp;
      return color && color[0] === "$" && (color = (0, import_core52.variableToString)(theme[color])), /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(YStack, { ref, ...stackProps, children: /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(import_react_native14.ActivityIndicator, { size: size3, color }) });
    }),
    {
...
// src/tamagui/config.ts
var import_animations_css = __toESM(require_cjs30());

// src/tamagui/themes.ts
var colors = {
  blackPrimary: "#0000000",
  whitePrimary: "#FFFFFF"
};
var themes = {
  light: {
...
var tokens = (0, import_core54.createTokens)({
  size: size2,
  space: size2,
  radius: size2,
...
var poppinsFont = (0, import_core54.createFont)({
