...
var PopperArrow = PopperArrowFrame.styleable(function(propsIn, forwardedRef) {
  var _a, _b;
  const { __scopePopper, ...rest } = propsIn, props = (0, import_core24.useProps)(rest), { offset: offset2, size: sizeProp, borderWidth = 0, ...arrowProps } = props, context = usePopperContext(__scopePopper), sizeVal = sizeProp ?? context.size, size2 = +(0, import_core24.getVariableValue)(
  ...
  if (primaryPlacement) {
    ...
    oppSide && (arrowStyle[oppSide] = -size2, innerArrowStyle[oppSide] = size2 / 2), (oppSide === "top" || oppSide === "bottom") && (arrowStyle.left = 0), (oppSide === "left" || oppSide === "right") && (arrowStyle.top = 0), (0, import_core24.useIsomorphicLayoutEffect)(() => {
      var _a2;
